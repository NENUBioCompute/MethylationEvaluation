...
robjects.r.source('/home/zongxizeng/methyTest/R/08/PedBE.R')
...
def PedBEAge(GEOID):
    ...
    print(ageData)
    file = '/home/zongxizeng/methyTest/ResultNew/08/' + FileName
...
#     errorGeo= []
#     for i in geo:
#         res_file = '/home/zongxizeng/methyTest/result/08_fill/' + i + '_predicted_by_NO.08.json'
