...
robjects.r.source('/home/zongxizeng/methyTest/R/06/LinAge.R')
...
def LinAge(GEOID):
    ...
    file = '/home/zongxizeng/methyTest/ResultNew/06/' + FileName
...
#
#     for i in ['GSE67444', ]:
#         res_file = '/home/zongxizeng/methyTest/result/06/' + i + '_predicted_by_NO.06.json'
