...
robjects.r.source('/home/zongxizeng/MethylationEvaluation/Evaluation/R/01/Horvath.R')


def HorvathAge(GEOID):
    # beta data path
    ...
    FileName = GEOID + "_predicted_by_NO.01.json"
    localTime = time.localtime()
    curTime = time.strftime("%Y-%m-%d %H:%M:%S", localTime)
    ageData = {
        "FileName": FileName,
        "datetime": curTime,
        "Algorithm": "NO.01_HorvathAge",
        "Dataset": GEOID,
    ...
    print(ageData)
    file = '/home/zongxizeng/MethylationEvaluation/Evaluation/ResultNew/01/' + FileName
...
#     # max_geo = ['GSE87571', 'GSE55763', 'GSE152026', 'GSE42861',  'GSE43414', 'GSE137904', 'GSE74193', 'GSE40279', 'GSE56105',
#     # 'GSE137841', 'GSE59685', 'GSE53740','GSE64511','GSE56581', ]
...
#     # max = ['GSE55763', 'GSE152016','GSE42861', 'GSE43414','GSE137904',]
#     for i in geo:
#         res_file = '/home/zongxizeng/MethylationEvaluation/Evaluation/result/01/' + i + '_predicted_by_NO.01.json'
